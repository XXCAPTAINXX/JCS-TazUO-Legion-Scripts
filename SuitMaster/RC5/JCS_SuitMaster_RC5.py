...
# Temporary compatibility loader: preload Legion API in the normal script context
# before reconstructing the preserved RC4 source with the RC5 medable-suit patch.
import API
import os
import hashlib
