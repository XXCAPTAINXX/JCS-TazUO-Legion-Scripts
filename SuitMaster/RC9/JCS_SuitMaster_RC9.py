...
#   - RC9: UO + InsaneUO named artifact slot registry; artifact footwear supported.
#   - RC7: Locks now snapshot targeted equipment and work independently of chest scans.
#   - RC5 hotfix: enforce medable filtering in the active top-3 optimizer path.
...
OPTIONAL_SLOTS = ("Earrings", "Talisman", "Belt", "Sash", "Robe", "Back", "Feet", "Shield")
...
BUILD_PROFILES = {
    ...
    "Basher Tamer": {
        "requirements": {
            "Physical Resist": 70, "Fire Resist": 70, "Cold Resist": 70,
            "Poison Resist": 70, "Energy Resist": 70,
            "Hit Chance Increase": 45, "Damage Increase": 100,
            "Lower Mana Cost": 30, "Faster Casting": 3, "Faster Cast Recovery": 6,
        },
        "weights": {
            "Hit Chance Increase": 5, "Damage Increase": 5, "Lower Mana Cost": 5,
            "Stamina Increase": 5, "Dexterity Bonus": 5,
            "Faster Casting": 5, "Faster Cast Recovery": 5,
            "Strength Bonus": 4, "Hit Point Increase": 4, "Mana Increase": 3,
            "Defense Chance Increase": 3, "Swing Speed Increase": 3,
            "Mana Regeneration": 2, "Soul Charge": 3,
            "Swordsmanship": 2, "Parrying": 2, "Tactics": 2,
            "Animal Taming": 2, "Animal Lore": 2, "Veterinary": 2, "Chivalry": 2,
        },
        "shield": True,
        "skill_budget": 60,
        "skill_budget_priority": 5,
        "skill_budget_skills": ["Swordsmanship","Parrying","Tactics","Animal Taming","Animal Lore","Veterinary","Chivalry"],
        "jewelry_skill_target": 30,
    },
    "Lucky Basher Tamer": {
        "requirements": {
            "Physical Resist": 70, "Fire Resist": 70, "Cold Resist": 70,
        ...
        "weights": {
            "Luck": 5, "Hit Chance Increase": 5, "Damage Increase": 5,
            "Lower Mana Cost": 5, "Stamina Increase": 5, "Dexterity Bonus": 4,
            "Faster Casting": 5, "Faster Cast Recovery": 5,
            "Hit Point Increase": 4, "Defense Chance Increase": 3,
            "Swing Speed Increase": 3, "Mana Increase": 2, "Mana Regeneration": 2,
            "Swordsmanship": 2, "Parrying": 2, "Tactics": 2,
            "Animal Taming": 2, "Animal Lore": 2, "Veterinary": 2, "Chivalry": 2,
        },
        "shield": True,
...
BUILD_NAMES = ["Basher", "Basher Tamer", "Lucky Basher Tamer", "Sampire", "Blood Knight", "Blood Tamer", "Mage", "Luck Dexer", "Luck Caster", "Hybrid Tamer", "Mystic Tank", "Necro Weaver Tamer", "Archer Tamer", "Custom"]
...
# ============================================================
# Named artifact slot registry
# ============================================================
# Built from UO artifact collections / UOGuide wearable artifact tables plus
# InsaneUO custom artifact and Doom-upgrade documentation.  This registry is
# intentionally name-based only for KNOWN named equipment. Legion's live layer
# remains authoritative when available, and conservative generic fallbacks are
# still used for normal loot.

ARTIFACT_SLOT_NAMES = {
    "Head": (
        "aegis of grace", "ancient farmer's kasa", "ancient farmers kasa",
        "ancient samurai helm", "anthropomorphist glasses", "black lotus hood",
        "brightsight lenses", "burglar's bandana", "burglars bandana",
        "captain john's hat", "captain johns hat", "crown of arcane temperment",
        "crown of tal'keesh", "crown of talkeesh", "daimyo's helm", "daimyos helm",
        "divine countenance", "dread pirate hat", "feudal kabuto",
        "folded steel reading glasses", "fortune's visage", "fortunes visage",
        "gypsy headdress", "hat of the magi", "helm of insight", "helm of swiftness",
        "helm of vengence", "helm of vengeance", "hexweaver's visage", "hexweavers visage",
        "hunter's headdress", "hunters headdress", "ironwood crown", "jester hat of chuckles",
        "kasa of the raj-in", "kasa of the raj in", "leurocian's mempo of fortune",
        "leurocians mempo of fortune", "light of the way reading glasses",
        "spirit of the totem", "treasures and trinkets reading glasses",
        "umbrascale champion's aegis", "umbrasccale champion's aegis",
        "wizard's crystal reading glasses", "wizards crystal reading glasses",
        "wyrmscale helm", "dr. spector's lenses", "dr spector's lenses",
        # InsaneUO / custom
        "king of antlers", "crown of the witchking", "crown of the witch king",
        "antlers of the forest lord", "antler master", "mask of the crazed mage",
        "helm of intuition", "mask of the barbarian", "skull of the harrower",
        "the scholar's halo", "the scholars halo", "witchhunter's blinders",
        "witchhunters blinders", "hat of the archmage",
    ),
    "Neck": (
        "elegant collar of fortune", "gladiator's collar", "gladiators collar",
        "jackal's collar", "jackals collar", "voice of the fallen king",
        "ankh pendant", "lavaliere", "pendant of the magi", "torc of the guardians",
        # InsaneUO upgrades
        "feudal collar", "voice of the risen king", "luck shamrock",
    ),
    "Arms": (
        "arms of tactical excellence", "bracers of alchemical devastation",
        "cast off zombie skin", "corrupted paladin vambraces", "cuffs of the arch mage",
        "cuffs of the archmage", "eldritch vambraces", "gauntlets of virtue bane",
        "general lethe's epaulettes", "general lethes epaulettes",
        "lord morphius's epaulettes", "lord morphiuss epaulettes", "song woven mantle",
        "spined bloodworm bracers", "stone arms of virtue bane",
        "warded demonbone bracers", "midnight bracers",
        # InsaneUO
        "paladin's pauldron", "paladins pauldron",
    ),
    "Hands": (
        "gauntlets of anger", "gauntlets of nobility", "gloves of the archlich",
        "gloves of feudal grip", "gloves of the holy warrior", "gloves of the pugilist",
        "gloves of the sun", "stitcher's mittens", "stitchers mittens", "stormgrip",
    ),
    "Chest": (
        "ancient samurai do", "armor of fortune", "armour of fortune",
        "basilisk hide breastplate", "bramble coat", "breastplate of the berserker",
        "bronzed armor of the valkyrie", "bronzed armour of the valkyrie",
        "heart of the lion", "holy knight's breastplate", "holy knights breastplate",
        "keeonean's chain mail", "keeoneans chain mail", "shadeweavers embrace",
        "shroud of deceit", "sugenja's raiment", "sugenjas raiment", "tunic of fire",
        "violet courage", "void touched corselet", "void touched cuirass",
        # InsaneUO / Witch / Doom upgrades
        "armor of prosperity", "armour of prosperity", "tunic of the inferno",
        "doublet of witchcraft",
    ),
    "Legs": (
        "animated legs of the insane tinker", "britches of warding",
        "clockwork leggings", "enchanted kelp leggings", "enchanted kelp woven leggings",
        "fey leggings", "giant steps", "gargish kilt of the archlich",
        "gargish kilt of the holy warrior", "leggings of bane", "legs of stability",
        "shadow dancer leggings", "spell woven britches", "summoner's kilt",
        "void infused kilt", "ninja harem leggings", "thunderkilt",
    ),
    "Ring": (
        "burning amber", "compassion's eye", "compassions eye", "crystalline ring",
        "demon bridle ring", "djinni's ring", "djinnis ring", "essence of battle",
        "etoile bleue", "katalkotl's ring", "katalkotls ring", "lune rouge",
        "petrified matriarch's tongue", "petrified matriarchs tongue",
        "ring of the elements", "ring of the soulbinder", "ring of the vile",
        # InsaneUO
        "ring of the villainous", "elden ring",
    ),
    "Bracelet": (
        "alchemist's bauble", "alchemists bauble", "bracelet of health",
        "bracelet of protection", "enchanted coral bracelet", "jade armband",
        "ornament of the magician", "novo bleue", "resillient bracer", "resilient bracer",
        "soleil rouge", "token of holy favor", "venom",
        # InsaneUO
        "bracelet of vital consumption", "insane mage's shackle", "insane mages shackle",
    ),
    "Earrings": (
        "nocturne earrings", "wamap's bone earrings", "wamaps bone earrings",
        "solaria's secret poisons", "solarias secret poisons", "yukio's glass earrings",
        "yukios glass earrings",
    ),
    "Talisman": (
        "a grammar of orcish", "a primer on arms", "birds of britannia", "bloodwood spirit",
        "conjurer's trinket", "conjurers trinket", "duelist's edge", "duelists edge",
        "enchantress' cameo", "enchantress cameo", "frostguard", "jade snake head",
        "lucky charm", "mana phasing orb", "my book", "mystic's memento", "mystics memento",
        "necromancer's phylactery", "necromancers phylactery", "slither", "soldier's medal",
        "soldiers medal", "talisman of the fey", "talking to wisps", "the life of a travelling minstrel",
        "totem of the tribe", "totem of the void", "treatise on alchemy", "wizard's curio",
        "wizards curio", "serpent's bite", "serpents bite",
        # InsaneUO
        "talisman of the witch",
    ),
    "Belt": (
        "crimson cincture", "obi di ense", "ozymandias' obi", "ozymandias obi", "tangle",
    ),
    "Sash": (
        "corgul's enchanted sash", "corguls enchanted sash", "runed sash of warding",
        "spell focusing sash", "lieutenant of the britannian royal guard", "tunic of vigor",
    ),
    "Robe": (
        "a necromancer shroud", "acid-proof robe", "acid proof robe", "cloak of corruption",
        "cloak of death", "cloak of life", "cloak of power", "cloak of silence",
        "conjurer's garb", "conjurers garb", "good samaritan of britain", "hawkwind's robe",
        "hawkwinds robe", "mystic's garb", "mystics garb", "robe of the equinox",
        "robe of the eclipse", "shroud of the condemned", "the robe of britannia",
        "embroidered oak leaf cloak", "the most knowledge person",
        # InsaneUO
        "shroud of insanity",
    ),
    "Back": (
        "cloak of light", "despicable quiver", "feathernock", "jumu's sacred hide",
        "jumus sacred hide", "melissa's cloak", "melissas cloak", "quiver of blight",
        "quiver of infinity", "quiver of rage", "quiver of the elements",
        "ranger's cloak of augmentation", "rangers cloak of augmentation",
        "royal guard investigator", "shadow cloak of rejuvenation",
        "feudal cloak of elements", "feudal wing armor", "unforgiven vail", "unforgiven veil",
        "wing armor of light", "serpent's skin quiver", "serpents skin quiver",
        "serpent's skin wing armor", "serpents skin wing armor", "shadow reaver's cloak",
        "shadow reavers cloak",
        # InsaneUO
        "dragon's wing", "dragons wing",
    ),
    "Feet": (
        "anon's boots", "anons boots", "boots of escaping", "elder detective of the royal guard",
        "legendary detective of the royal guard", "mythical detective of the royal guard",
        "minax's sandals", "minaxs sandals", "pads of the cu sidhe", "shanty's waders",
        "shantys waders", "unicorn mane woven talons", "unicorn mane woven sandals",
        "soles of providence", "void skipper's boots", "void skippers boots",
    ),
    "Shield": (
        "aegis", "arcane shield", "boura tail shield", "chaos shield - museum of vesper replica",
        "defender of the magus", "dragon hide shield", "dupre's shield", "dupres shield",
        "grugor's shield", "grugors shield", "hephaestus", "light's rampart", "lights rampart",
        "lord blackthorn's exemplar", "lord blackthorns exemplar", "maleki's honor", "malekis honor",
        "mystic's guard", "mystics guard", "order shield - museum of vesper replica",
        "pillar of strength", "planeshield", "resonant shield of vengeance", "sentinel's guard",
        "sentinels guard", "shield of invulnerability", "sign of chaos", "sign of order",
        "surge shield", "tongue of the beast", "wall of hungry mouths",
        "lantern of protection", "hildebrandt shield", "ruckus rum", "wand of warding",
        "lantern of love", "verdant", "shillelagh", "whimsy wine", "orb of sosaria",
        # InsaneUO upgraded Doom
        "enigmatic shield",
    ),
}

# Exact-match lookup. Also tolerate InsaneUO's Gargish conversion prefix and a
# few punctuation differences without turning the registry into fuzzy guessing.
def artifact_slot_for_name(name):
    n = str(name or "").lower().strip()
    n = n.replace("’", "'").replace("`", "'")
    n = re.sub(r"\\s+", " ", n)
    for prefix in ("gargish ", "gargoyle "):
        if n.startswith(prefix):
            n = n[len(prefix):].strip()
            break
    for slot, names in ARTIFACT_SLOT_NAMES.items():
        if n in names:
            return slot
    return None
...
def classify_slot(item, opl):
    ...
    artifact_slot = artifact_slot_for_name(name)
    if artifact_slot:
    ...
    if "robe" in name:
        return "Robe"
    if any(x in name for x in ("boots", "sandals", "shoes", "slippers", "talons", "waders")):
        return "Feet"

    # Armor fallbacks. Head is checked before any broad torso wording so names
    # such as "Winged Helm" can never become Back gear.
    # Named/artifact headgear often does not contain the words helm or helmet.
    # These are still conservative item-name signals for things worn on Head.
    if any(x in name for x in (
        "helmet", "helm", "cap", "hat", "cowl", "circlet",
        "antlers", "deer mask", "bear mask", "tribal mask", "orc mask",
        "mask of", "skullcap", "bandana", "bonnet", "wizard hat"
    )):
        return "Head"
    if "gorget" in name:
        return "Neck"
...
def profile_skill_pool(profile):
    pool = profile.get("skill_budget_skills", []) if isinstance(profile, dict) else []
    if isinstance(pool, list) and pool:
        valid = [str(x) for x in pool if str(x) in EQUIPMENT_SKILLS]
        if valid:
            return valid
    return list(EQUIPMENT_SKILLS)

def profile_skill_total(totals, profile):
    return sum(max(0, int((totals or {}).get(skill_name, 0) or 0)) for skill_name in profile_skill_pool(profile))

def item_useful_skill_total(item, profile):
    props = effective_item_props(item)
    return sum(max(0, int(props.get(skill_name, 0) or 0)) for skill_name in profile_skill_pool(profile))

def jewelry_skill_state(chosen, profile):
    target = max(0, int(profile.get("jewelry_skill_target", 0) or 0))
    rows = []
    for item in chosen or []:
        if str(item.get("slot", "")) not in ("Ring", "Bracelet"):
            continue
        rows.append((str(item.get("slot")), item_useful_skill_total(item, profile)))
    return target, rows
...
def hard_minimum_state(totals, profile):
    ...
    budget_deficit = 0
    if budget > 0:
        actual_budget = profile_skill_total(totals, profile)
...
def item_rough_score(item, profile):
    ...
    budget = max(0, int(profile.get("skill_budget", 0) or 0))
    if budget > 0:
        pts = item_useful_skill_total(item, profile)
        if pts > 0:
            score += pts * 3500.0
            if str(item.get("slot", "")) in ("Ring", "Bracelet"):
                target = max(0, int(profile.get("jewelry_skill_target", 0) or 0))
                if target:
                    score += min(pts, target) * 2500.0
...
BUILTIN_PROFILE_NAMES = ["Basher", "Basher Tamer", "Lucky Basher Tamer", "Sampire", "Blood Knight", "Blood Tamer", "Mage", "Luck Dexer", "Luck Caster", "Hybrid Tamer", "Mystic Tank", "Necro Weaver Tamer", "Archer Tamer", "Custom"]

PROFILE_DISPLAY_NAMES = {
    "Basher": "Shield Bash Basher",
    "Basher Tamer": "Basher Tamer",
    "Lucky Basher Tamer": "Lucky Basher Tamer",
    "Sampire": "Sampire",
...
PROFILE_DESCRIPTIONS = {
    ...
    "Basher Tamer": "Shield Bash + pet build with a 60-point useful equipment-skill budget, targeting 30 useful skill points on each jewelry piece.",
    "Lucky Basher Tamer": "Luck-focused Basher + pet build that preserves the same 60-point useful skill budget before maximizing Luck.",
...
PROFILE_SKILLS = {
    ...
    "Basher Tamer": [
        ("Swordsmanship", "120 effective", "May be reduced in real points when jewelry supplies skill"),
        ("Parrying", "120 effective", "Core Shield Bash skill"),
        ("Tactics", "120 effective", "Core melee damage"),
        ("Animal Taming", "115 effective", "Required pet control target"),
        ("Animal Lore", "115 effective", "Required pet control target"),
        ("Veterinary", "80+ effective", "Pet healing and resurrection"),
        ("Chivalry", "80+ effective", "Self healing and combat utility"),
        ("Jewelry", "+30 each target", "Any useful combination of the seven build skills counts"),
    ],
    "Lucky Basher Tamer": [
        ("Core", "Same as Basher Tamer", "Preserve effective skill requirements first"),
        ("Jewelry", "+30 each target", "Any useful build-skill combination counts"),
        ("Luck", "Maximize", "Luck is optimized only after hard combat and skill requirements"),
    ],
    "Sampire": [
...
def make_profile_record(name, source):
    ...
    return {
        ...
        "skill_budget_skills": list(source.get("skill_budget_skills", []) or []),
        "jewelry_skill_target": max(0, int(source.get("jewelry_skill_target", 0) or 0)),
...
def default_profiles():
    ...
    for profile_name in ("Basher Tamer", "Lucky Basher Tamer"):
        if profile_name in out:
            p = out[profile_name]
            p["skill_budget"] = 60
            p["skill_budget_priority"] = 5
            p["skill_budget_skills"] = ["Swordsmanship","Parrying","Tactics","Animal Taming","Animal Lore","Veterinary","Chivalry"]
            p["jewelry_skill_target"] = 30
            p["targets"]["Hit Chance Increase"] = 45
            p["targets"]["Damage Increase"] = 100
            p["targets"]["Defense Chance Increase"] = 45
            p["targets"]["Lower Mana Cost"] = 40
            ...
            p["core_skills"] = {
                ...
                "Parrying":{"base":120.0,"value":120.0,"cap":120.0},
                "Tactics":{"base":120.0,"value":120.0,"cap":120.0},
                "Animal Taming":{"base":100.0,"value":115.0,"cap":120.0},
                "Animal Lore":{"base":100.0,"value":115.0,"cap":120.0},
                "Veterinary":{"base":80.0,"value":95.0,"cap":120.0},
                "Chivalry":{"base":80.0,"value":95.0,"cap":120.0},
            }
    if "Lucky Basher Tamer" in out:
        out["Lucky Basher Tamer"]["targets"]["Luck"] = 1500
        out["Lucky Basher Tamer"]["weights"]["Luck"] = 5
...
def sanitize_profile(name, raw):
    ...
    pool = raw.get("skill_budget_skills", base.get("skill_budget_skills", []))
    if isinstance(pool, list):
        base["skill_budget_skills"] = [str(x) for x in pool if str(x) in EQUIPMENT_SKILLS]
    try:
        base["jewelry_skill_target"] = max(0, int(raw.get("jewelry_skill_target", base.get("jewelry_skill_target", 0)) or 0))
    except:
        base["jewelry_skill_target"] = 0
...
def load_profiles_db():
    ...
    for name in BUILTIN_PROFILE_NAMES:
        ...
        if name in ("Basher Tamer", "Lucky Basher Tamer"):
            merged[name] = defaults[name]
        elif name == "Basher" and not saved_version.startswith("2.2"):
            merged[name] = defaults[name]
...
def active_profile():
    ...
    return {
        ...
        "skill_budget_skills": list(p.get("skill_budget_skills", []) or []),
        "jewelry_skill_target": int(p.get("jewelry_skill_target", 0) or 0),
...
def useful_upgrade_properties(best):
    ...
    if _build in ("Basher", "Basher Tamer", "Lucky Basher Tamer"):
...
def profile_share_payload(name):
    ...
    return {
        ...
        "bsk": list(p.get("skill_budget_skills", []) or []),
        "jst": int(p.get("jewelry_skill_target", 0) or 0),
...
def decode_profile_code(code):
    ...
    raw_profile = {
        ...
        "skill_budget_skills": payload.get("bsk", []),
        "jewelry_skill_target": int(payload.get("jst", 0) or 0),
...
def show_profile_editor(profile_name, section_name=None):
    ...
    def capture_page():
        data = {
            ...
            "skill_budget_skills": list(source.get("skill_budget_skills", []) or []),
            "jewelry_skill_target": int(source.get("jewelry_skill_target", 0) or 0),
            "core_skills": dict(source.get("core_skills", {}) or {}),
            "scan_source": dict(source.get("scan_source", {}) or {}),
        }
...
def _clean_locked_record(record):
    """Return a JSON-safe SuitMaster item snapshot for a persistent lock."""
    if not isinstance(record, dict):
        return None
    try:
        slot = str(record.get("slot", "") or "")
        serial_value = int(record.get("serial", 0) or 0)
    except:
        return None
    if slot not in SLOTS or not serial_value:
        return None
    return {
        "serial": serial_value,
        "name": str(record.get("name", "item") or "item"),
        "slot": slot,
        "graphic": int(record.get("graphic", 0) or 0),
        "hue": int(record.get("hue", 0) or 0),
        "layer": str(record.get("layer", "") or ""),
        "source_chest": int(record.get("source_chest", 0) or 0),
        "source_container": int(record.get("source_container", 0) or 0),
        "props": dict(record.get("props", {}) or {}),
        "opl": str(record.get("opl", "") or ""),
...
def save_locks():
    try:
        payload = {}
        for slot, serial_value in _locked_items.items():
            rec = _clean_locked_record(_locked_item_data.get(slot))
            payload[str(slot)] = {
...
def load_locks():
    global _locked_items, _locked_item_data
    ...
    try:
        ...
        if isinstance(raw, dict):
            for slot, value in raw.items():
                try:
                    # Format 1 stored only a serial. Format 2 stores the serial
                    # plus a complete item snapshot, so the lock does not depend
                    # on that item being present in a later chest scan.
                    if isinstance(value, dict):
                        serial_value = int(value.get("serial", 0) or 0)
                        rec = _clean_locked_record(value.get("item"))
                    else:
                        serial_value = int(value or 0)
                        rec = None
                    if slot in SLOTS and serial_value:
                        _locked_items[slot] = serial_value
                        if rec and int(rec.get("serial", 0) or 0) == serial_value:
                            _locked_item_data[slot] = rec
                except:
                    pass
    except:
        _locked_items = {}
...
def _snapshot_lock_target(target):
    """Scan one targeted item immediately, independent of configured chests."""
    try:
        obj = API.FindItem(int(target))
    except:
        obj = None

    # If Legion cannot currently resolve the object but it was previously in a
    # SuitMaster scan, use that known record as a fallback.
    if obj is None:
        for known in _items:
            try:
                if int(known.get("serial", 0) or 0) == int(target):
                    return _clean_locked_record(known)
            except:
                pass
        return None

    try:
        API.RequestOPLData([int(target)])
        API.Pause(OPL_BATCH_PAUSE)
    except:
        try:
            API.RequestOPLData(int(target))
    ...
    opl = item_opl(obj)
    if not item_race_compatible(obj, opl):
        return None
    slot = classify_slot(obj, opl)
    if slot not in SLOTS:
        return None

    return _clean_locked_record({
        "serial": serial(obj),
        "name": item_name(obj),
        "slot": slot,
        "graphic": item_graphic(obj),
        "hue": item_hue(obj),
        "layer": item_layer(obj),
        "source_chest": 0,
        "source_container": int(item_container(obj) or 0),
        "props": parse_props(opl),
        "opl": opl,
    })
...
def locked_item_entries():
    """Return complete locked records, whether or not they are in _items."""
    out = []
    ...
    for slot, serial_value in list(_locked_items.items()):
        serial_value = int(serial_value or 0)
        # Prefer a fresh chest-scan record when available, but otherwise keep
        # using the persistent snapshot captured at lock time.
        item = by_serial.get(serial_value)
        if item:
            rec = _clean_locked_record(item)
            if rec:
                _locked_item_data[slot] = rec
        else:
            rec = _clean_locked_record(_locked_item_data.get(slot))
...
def lock_target_item():
    ...
    target = request_target(
        "Target any armor, jewelry, talisman, accessory, or shield to lock. "
        "It does not need to be in a SuitMaster chest."
    )
    if not target:
        set_status("No item selected.", 33)
        return

    match = _snapshot_lock_target(target)
    if not match:
        set_status("SuitMaster could not read that target as wearable equipment.", 33)
        return
    ...
    _locked_items[slot] = int(target)
    _locked_item_data[slot] = match
    save_locks()
    set_status(
        "Locked {}: {}. Saved independently of chest scans.".format(
            slot, match.get("name", "item")
        ),
        68
    )
    refresh_main()
...
def build_combination_adjustment(chosen, totals, profile_name=None):
    name = profile_name or _build
    score = 0.0
    if name in ("Basher", "Basher Tamer", "Lucky Basher Tamer"):
        score += basher_suit_adjustment(chosen, totals)
    profile = active_profile()
    target, rows = jewelry_skill_state(chosen, profile)
    if target > 0:
        for slot, pts in rows:
            score += min(pts, target) * 5000.0
            if pts >= target:
                score += 75000.0
    return score
...
def top_unique_suits(ranked, count=5):
    ...
    for final_score, raw_score, chosen, totals in ranked:
        ...
        lmc = suit_lmc_state(chosen, totals) if _build in ("Basher", "Basher Tamer", "Lucky Basher Tamer") else None
...
def optimize():
    ...
    # Locked pieces are persistent candidate records, not merely serials from
    # the last chest scan. Inject them into the candidate source before any
    # slot/medability filtering so a targeted backpack/equipped/other-container
    # item can participate in the build exactly like scanned chest gear.
    source_items = list(_items)
    seen_source_serials = set(int(x.get("serial", 0) or 0) for x in source_items)
    for locked_record in locked_item_entries():
        ls = int(locked_record.get("serial", 0) or 0)
        if ls and ls not in seen_source_serials:
            source_items.append(locked_record)
            seen_source_serials.add(ls)
    ...
    for item in source_items:
        ...
        # IMPORTANT: this is the active RC4/RC5 optimizer.  Enforce the
        # meditation constraint here, before candidates are grouped/pruned.
        # This makes non-medable armor impossible to enter the search beam.
        if profile.get("medable", False) and not item_is_medable(item):
            medable_rejected.append(item)
            continue
    ...
    if invalid_locks:
        if profile.get("medable", False):
            set_status(
                "Some locks are unavailable or non-medable: " + ", ".join(invalid_locks),
                33
            )
        else:
            set_status(
                "Some locked items are unavailable or no longer readable: " + ", ".join(invalid_locks),
                33
            )
...
def show_results():
    ...
    # Useful +skill summary for this build.
    add_panel(g, 14, 580, 942, 110)
    add_label(g, "SKILL BONUSES", 30, 594, 180, 22, 14, C_GOLD)
    pool = profile_skill_pool(profile)
    skill_rows = [(sk, int(totals.get(sk, 0) or 0)) for sk in pool if int(totals.get(sk, 0) or 0) > 0]
    total_useful = sum(v for _, v in skill_rows)
    add_label(g, "Useful total", 220, 594, 105, 22, 12, C_TEXT)
    budget = int(profile.get("skill_budget", 0) or 0)
    total_color = C_GREEN if (not budget or total_useful >= budget) else C_RED
    add_label(g, "+{}{}".format(total_useful, " / {}".format(budget) if budget else ""), 320, 594, 75, 22, 13, total_color, "right")
    sy = 620
    for idx, (sk, val) in enumerate(skill_rows[:8]):
        col = 0 if idx < 4 else 1
        row = idx if idx < 4 else idx - 4
        sx = 30 + (col * 245)
        yy = sy + (row * 18)
        add_label(g, sk, sx, yy, 165, 18, 10, C_TEXT)
        add_label(g, "+{}".format(val), sx + 170, yy, 45, 18, 11, C_GREEN, "right")
    target, jewel_rows = jewelry_skill_state(items, profile)
    jy = 620
    for slot, pts in jewel_rows:
        color = C_GREEN if (not target or pts >= target) else C_GOLD
        add_label(g, "{} useful".format(slot), 545, jy, 110, 18, 10, C_MUTED)
        add_label(g, "+{}{}".format(pts, "/{}".format(target) if target else ""), 655, jy, 65, 18, 11, color, "right")
        jy += 20

    if budget > 0:
        pool_text = ", ".join(pool)
        if len(pool_text) > 38:
            pool_text = pool_text[:35] + "..."
        add_label(g, "Counts: " + pool_text, 545, 666, 380, 18, 9, C_MUTED)
    ...
    add_button(g, "PREVIOUS", 30, 785, 105, 30, candidate_prev)
    add_button(g, "NEXT", 145, 785, 105, 30, candidate_next)
    add_button(g, "PULL SUIT", 275, 785, 165, 30, pull_best_suit)
    add_button(g, "RETURN SUIT", 450, 785, 155, 30, return_active_suit)
    add_button(g, "CLOSE", 842, 785, 95, 30, lambda: dispose(g))
